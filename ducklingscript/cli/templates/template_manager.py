...
class TemplateManager:
    ...
    def _create_default_template_manager(cls):
        ...
        instance.add_template(TemplateClass.PLUGINS, "default", temp / "plugins", "Default plugin template")
        return instance
    ...
    def list_all_templates(self) -> list[Template]:
        ...
        return [template for templates in self.templates.values() for template in templates]
