...
def new(
    ...
    for i in name:
        if i not in 'abcdefghijklmnopqrstuvwxyz1234567890-':
            print_error("Names must require only letters and numbers. If there are spaces, they are replaced with '-'. If there are any upper case letters, they are made lower case.")
            return
