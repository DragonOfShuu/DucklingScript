...
class ProjectEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        self.global_compile_options = CompileOptions() if compile_options is None else compile_options
    ...
    def calculate_options(self):
        ...
        if not self.__global_compile_options.use_project_config: return
        ...
        if not project_options.use_project_config: return
